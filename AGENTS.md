...
- Do not introduce React, ProseMirror, Electron, a frontend component framework, tabs, export, file watching, or a plugin system without explicit product approval.
...
- `src-tauri/src/files.rs`: native dialogs, UTF-8 file I/O, and constrained local image loading
...
- Native file access must remain behind narrow custom Tauri commands.
